...
namespace WPF.Reader.Api
{
    ...
    public interface IBookApiSync : IApiAccessor
    {
        ...
        List<BookWithoutContent> BookGetBooks(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<BookWithoutContent>> BookGetBooksWithHttpInfo(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="WPF.Reader.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IBookApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<BookWithoutContent>> BookGetBooksAsync(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<BookWithoutContent>>> BookGetBooksWithHttpInfoAsync(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class BookApi : IBookApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;BookWithoutContent&gt;</returns>
        public List<BookWithoutContent> BookGetBooks(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            WPF.Reader.Client.ApiResponse<List<BookWithoutContent>> localVarResponse = BookGetBooksWithHttpInfo(genres, offset, limit);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;BookWithoutContent&gt;</returns>
        public WPF.Reader.Client.ApiResponse<List<BookWithoutContent>> BookGetBooksWithHttpInfo(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'genres' is set
            if (genres == null)
            {
                throw new WPF.Reader.Client.ApiException(400, "Missing required parameter 'genres' when calling BookApi->BookGetBooks");
            }
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            ...
            localVarRequestOptions.Data = genres;
            localVarRequestOptions.Operation = "BookApi.BookGetBooks";
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<BookWithoutContent>>("/api/Book/GetBooks", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;BookWithoutContent&gt;</returns>
        public async System.Threading.Tasks.Task<List<BookWithoutContent>> BookGetBooksAsync(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.ApiResponse<List<BookWithoutContent>> localVarResponse = await BookGetBooksWithHttpInfoAsync(genres, offset, limit, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;BookWithoutContent&gt;)</returns>
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<List<BookWithoutContent>>> BookGetBooksWithHttpInfoAsync(List<int> genres, int? offset = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'genres' is set
            if (genres == null)
            {
            ...
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<BookWithoutContent>>("/api/Book/GetBooks", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BookGetBooks", localVarResponse);
                if (_exception != null)
...
namespace WPF.Reader.Model
{
    ...
    public partial class Book : IEquatable<Book>, IValidatableObject
    {
        ...
        public Book(int id = default(int), string name = default(string), double price = default(double), string content = default(string), List<Genre> genres = default(List<Genre>))
        {
            this.Id = id;
            this.Price = price;
            this.Name = name;
...
namespace WPF.Reader.Model
{
    ...
    public partial class BookWithoutContent : IEquatable<BookWithoutContent>, IValidatableObject
    {
        ...
        /// <param name="price">price (required).</param>
        /// <param name="genres">genres.</param>
        public BookWithoutContent(int id = default(int), string name = default(string), double price = default(double), List<Genre> genres = default(List<Genre>))
        {
            this.Id = id;
            this.Price = price;
            this.Name = name;
